...
# those options that take arguments are followd by a colon
optstring=f:v

# The loop calls getops until there are no more options on the command line
